...
public class SolicitacaoCadastroViewModel {
	...
	public SolicitacaoCadastroViewModel(Long id, TipoPessoa tipoPessoa, String nome, String cep, String endereco,
			String bairro, String numero, String complemento, String telefone, String celular, String email,
			Cidade cidade, LocalDate dataCriacao, String documento, boolean ehProfessor, String nomeInstituicao,
			String nomeProgramaEnsino, LocalDate dataTerminoPrograma, String cpfOrientador, String nomeProjeto) {
		this.id = id;
