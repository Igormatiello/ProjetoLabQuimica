...
//        ROLES(SOLICITANTE, ATENDENTE, ADMIN)
        http.csrf().disable()
                ...
                .antMatchers("/pessoa/doc-exists/**").permitAll()
                .antMatchers("/pessoa/**").authenticated()
                .antMatchers("/amostra-formulario/**").hasAnyRole("ADMIN")
                .antMatchers("/anexo-formulario/**").hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/equipamento").authenticated()
                ...
                .antMatchers(HttpMethod.POST, "/formulario").authenticated()
                .antMatchers("/formulario/**").hasAnyRole("ADMIN")
                .antMatchers("/instituicao/**").hasAnyRole("ADMIN")
                .antMatchers("/lancamento-financeiro/**").hasAnyRole("ADMIN")
                .antMatchers("/papel/**").hasAnyRole("ADMIN")
                .antMatchers("/participacao-programa-ensino/pessoa-instituicao/**").authenticated()
                .antMatchers("/participacao-programa-ensino/**").hasAnyRole("ADMIN")
                .antMatchers("/pessoa-intituicao/**").hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/servico/equipamento").authenticated()
                .antMatchers("/servico/**").hasAnyRole("ADMIN")
                .antMatchers("/solicitacao-cadastro/new").permitAll()
                .antMatchers("/solicitacao-cadastro/**").hasAnyRole("ADMIN")
                .antMatchers("/usuario/**").hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.GET,"/creditoProfessor/buscaCreditosPorProfessor/**").authenticated()
                .antMatchers("/creditoProfessor/**").hasAnyRole("ADMIN")
