...
public class DadosPessoaViewModel {
    ...
    public DadosPessoaViewModel(Long pessoaId, TipoPessoa tipoPessoa, String nome, String documento, String cep, String endereco, String bairro, String numero, String complemento, String telefone, String celular, String email, String inscricaoEstadual, LocalDate dataCriacao, boolean ehAtivo, Cidade cidade, Usuario usuario, List<PessoaInstituicao> pessoaInstituicoes) {
