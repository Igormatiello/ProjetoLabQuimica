...
public class EquipamentoRepositoryTests {
	...
	public static Equipamento criarEquipamento() {
		...
		return Equipamento.builder().nome("AA").sigla("AAA").metodologia("metodologia").laudoPadrao("laudo padrão")
				.observacoesFixas("observações fixas").unidadeMedidaExterno(UnidadeMedidaCobrancaEquipamento.Amostra)
				.valorInterno(222e10).unidadeMedidaExterno(UnidadeMedidaCobrancaEquipamento.Amostra)
				.valorExterno(111e10).unidadeMedidaPadrao(UnidadeMedidaCobrancaEquipamento.Amostra).valorPadrao(121e10)
				.servicos(servicos).build();
