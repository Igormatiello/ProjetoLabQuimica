...
public void deveDeletarUmaPessoaInstituicao() {
	...
	PessoaInstituicao pessoaInstituicaoInexistente = entityManager.find(PessoaInstituicao.class, pessoaInstituicao.getId());
...
public void deveAtualizarUmaPessoaInstituicao() {
	...
	PessoaInstituicao pessoaInstituicaoAtualizada = entityManager.find(PessoaInstituicao.class, pessoaInstituicao.getId());
	...
	Assertions.assertThat(pessoaInstituicaoAtualizada.getInstituicao().getTipoInstituicao()).isEqualTo(TipoInstituicao.Externa);
